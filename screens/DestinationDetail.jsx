...
const StarReview = ({ rate }) => {
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
      {starComponents}
      <Text style={{ marginLeft: SIZES.base, color: COLORS.gray, fontSize: 16 }}>{rate}</Text>
    </View>
  )
}
...
const IconLabel = ({ icon, label }) => {
  return (
    <View style={{ alignItems: 'center' }}>
      ...
      />
      <Text style={{ marginTop: SIZES.padding, color: COLORS.gray, fontSize: 20 }}>{label}</Text>
    </View>
  )
}
    ...
    <View style={styles.container}>
        ...
        >
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around' }}>
              <Text style={{ fontSize: 24, fontWeight: "bold" }}>Ski Villa</Text>
              <Text style={{ color: COLORS.gray, fontSize: 20 }}>France</Text>
      ...
      <View style={{ flex: 1.5 }}>
        ...
        <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding }}>
          ...
          <Text style={{ marginTop: SIZES.radius, color: COLORS.gray, fontSize: 17 }}>
